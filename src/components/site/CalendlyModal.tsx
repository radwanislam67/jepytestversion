      ...
      >
        <div className="flex items-center justify-between gap-3 px-4 md:px-6 py-3 border-b border-white/5 bg-[#0a0a0a]">
          <button
            type="button"
            onClick={onClose}
            className="text-sm font-medium text-foreground/80 hover:text-[#30d94b] transition-colors"
          >
        ...
        <div className="relative flex-1 bg-[#0a0a0a]">
          {loading && !failed && (
            <div className="absolute inset-0 flex flex-col items-center justify-center gap-3 z-10 bg-[#0a0a0a]">
              <Loader2 size={28} className="animate-spin text-[#30d94b]" />
          ...
          {failed ? (
            <div className="absolute inset-0 flex flex-col items-center justify-center gap-4 px-6 text-center">
              ...
              <a
                ...
                target="_blank"
                rel="noreferrer"
                className="inline-flex items-center gap-2 rounded-full bg-[#30d94b] text-[#141414] font-semibold px-6 py-3 hover:brightness-110 transition"
              >
