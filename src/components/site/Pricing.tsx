...
const TIERS = [
  ...
  },
  {
    ...
    features: [
      "20 reels/month",
      "Custom motion graphics per reel",
      "Trending hook optimization",
      "Captions & platform-ready export",
      "Unlimited revisions",
      "24h delivery",
      "Dedicated editor",
      "5 AI Sponsored Videos/month",
  ...
  {
    name: "Premium",
    price: "Starting at $4,497/month",
    features: [
      "30+ reels/month",
      "Advanced motion design per reel",
      "Hook-first editing strategy",
      "Dedicated editor",
      "10 AI Sponsored Videos/month",
      "8 Educational Videos/month",
