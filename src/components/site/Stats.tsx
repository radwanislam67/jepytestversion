...
function StatItem({ stat, delay }: { stat: Stat; delay: number }) {
  ...
  return (
    <div ref={wrapRef} className="text-center md:text-left will-change-transform">
      <div
        ref={numRef}
        className="font-display text-5xl md:text-6xl font-semibold tabular-nums"
        style={{
          color: "var(--accent)",
      ...
      <div className="mt-3 text-sm md:text-base uppercase tracking-[0.18em] text-foreground/50">
        {stat.label}
      </div>
    </div>
  );
