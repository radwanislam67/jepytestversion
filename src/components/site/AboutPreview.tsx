    ...
    <div className="relative">
      <div
        ...
        style={{
          aspectRatio: "4 / 3",
          borderRadius: 16,
          border: "1px solid rgba(48, 217, 75,0.45)",
          boxShadow: "0 0 40px rgba(48, 217, 75,0.22), inset 0 0 60px rgba(48, 217, 75,0.04)",
        }}
      >
        {SLIDES.map((s, i) => (
          <div
      ...
      <div
        ...
        style={{
          ...
          borderRadius: 999,
          background: "#30d94b",
          boxShadow: "0 0 14px rgba(48, 217, 75,0.9), 0 0 28px rgba(48, 217, 75,0.55)",
          ...
          <Reveal>
            <div className="text-left">
              ...
              <div className="mt-8">
                <Link
                  to="/about"
                  className="inline-flex items-center gap-2 px-6 py-3 rounded-full border border-[var(--accent)] text-[var(--accent)] bg-transparent font-medium transition-all duration-300 hover:bg-[var(--accent)] hover:text-black hover:scale-105 hover:shadow-[0_0_24px_rgba(48, 217, 75,0.45)]"
                >
