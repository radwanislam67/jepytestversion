  ...
  server: {
    handlers: {
      POST: async ({ request }) => {
        ...
        const html = `
          <div style="font-family:Inter,Arial,sans-serif;background:#141414;color:#f3f4f6;padding:32px">
            <h2 style="color:#30d94b;margin:0 0 16px">New Contact Form Submission</h2>
            ...
            <h3 style="color:#30d94b;margin:24px 0 8px">Message</h3>
