                  ...
                  <form ref={formRef} onSubmit={onSubmit} noValidate aria-busy={submitting} className="grid grid-cols-1 md:grid-cols-2 gap-3 md:gap-5">
                    ...
                    <div className="md:col-span-2 flex flex-col gap-4 pt-2">
                      ...
                      <button
                        ...
                        className="w-full h-12 px-6 py-3 inline-flex items-center justify-center gap-2 rounded-full bg-[#a3e635] text-[#0f1610] font-semibold transition-all duration-200 hover:scale-105 hover:brightness-110 hover:cursor-pointer focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-offset-[#0f1610] focus:ring-green-400 disabled:opacity-50 disabled:cursor-not-allowed disabled:hover:scale-100"
                      >
  ...
  return (
    <div>
      ...
      <select
        ...
        aria-invalid={!!error || undefined}
        aria-describedby={error ? errorId : undefined}
        className={`${fieldBase(error)} appearance-none pr-10 bg-[url('data:image/svg+xml;utf8,<svg xmlns=%22http://www.w3.org/2000/svg%22 width=%2212%22 height=%2212%22 viewBox=%220 0 24 24%22 fill=%22none%22 stroke=%22%23a3e635%22 stroke-width=%222%22><polyline points=%226 9 12 15 18 9%22/></svg>')] bg-no-repeat bg-[right_1rem_center] ${!value ? "text-gray-400" : "text-white"}`}
      >
    ...
    <div>
      ...
      <div className="relative mt-2 group">
        ...
        <button
          ...
          aria-hidden="true"
          onClick={openPicker}
          className="pointer-events-none absolute right-2 top-1/2 -translate-y-1/2 h-8 w-8 rounded-full bg-[#0b0b0b] border border-green-500/40 flex items-center justify-center text-[#a3e635] shadow-[0_0_0_0_rgba(163,230,53,0)] transition-all duration-200 group-hover:shadow-[0_0_14px_-2px_rgba(163,230,53,0.7)] group-hover:border-green-400 group-focus-within:border-green-300 group-focus-within:shadow-[0_0_16px_-2px_rgba(163,230,53,0.8)]"
        >
