    ...
    <div>
      ...
      <div className="relative mt-2 group">
        ...
        <button
          ...
          aria-hidden="true"
          onClick={openPicker}
          className="pointer-events-none absolute right-2 top-1/2 -translate-y-1/2 h-8 w-8 rounded-full bg-[#0b0b0b] border border-green-500/40 flex items-center justify-center text-[#30d94b] shadow-[0_0_0_0_rgba(48, 217, 75,0)] transition-all duration-200 group-hover:shadow-[0_0_14px_-2px_rgba(48, 217, 75,0.7)] group-hover:border-green-400 group-focus-within:border-green-300 group-focus-within:shadow-[0_0_16px_-2px_rgba(48, 217, 75,0.8)]"
        >
